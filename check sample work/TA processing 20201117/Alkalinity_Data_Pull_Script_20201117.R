...
#  "alkalinity run 10NOV2020 samples only.csv"

#   sample environmental data
# "20201110 sample metadata.csv"  

# alkalinity titration data file
# "alkalinity run 10NOV2020 data shifted.csv"  


# read in sample summary information ####-----------------------------------------------------

df_sum = read.csv("alkalinity run 10NOV2020 samples only.csv",
...
df = read.csv("alkalinity run 10NOV2020 data shifted.csv",
               header=F, skip = 17, stringsAsFactors=F, sep=",")
