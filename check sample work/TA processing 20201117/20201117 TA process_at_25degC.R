...
setwd(here("check sample work", "TA processing 20201117"))
...
# [9] "ALKCRM-1.csv"                              "ALKCRM-2.csv"                             
# [11] "ALKCRM-3.csv"                              "P-0078-1.csv"                             
# [13] "P-0078-2.csv"                              "P-0078-3.csv"                             
# [15] "P-0078-4.csv"                              "P-0078-5.csv"                             
# [17] "P-0078-6.csv"                              "P-0078-7.csv"                             
# [19] "SAC-1.csv"                                 "SAC-2.csv"           

#get character vector of samples ------------------------------------------------------

df_env = read.csv("20201110 sample metadata.csv",
...
# data <- read.csv("ALKCRM1.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("ALKCRM2.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("R2T1-1.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("R2T1-2.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("R2T1-3.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("R2T2-1.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("R2T2-2.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("R2T2-3.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("ALKCRM3.csv", header=T, stringsAsFactors=F, sep=",")
# data <- read.csv("ALKCRM4.csv", header=T, stringsAsFactors=F, sep=",")
